...
function loadLevel(levelObject) {
    let levelBalls = levelObject.balls;
    let platforms = levelObject.platforms;
    let playerPosition = levelObject.player.position;
    let backgroundName = levelObject.background;
    ...
    numOfProjectiles = 1;
    projectilesInUse = 0;
    let i = projectiles.children.length;
    while (i--) {
