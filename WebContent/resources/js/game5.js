...
function preload() {
	...
	game.load
			.image('ground_invisible', '../resources/images/dak_invisible.png');
	...
	game.load.image('snowball_16',
			'../resources/images/snowballs/snowball_16.png');
	game.load.image('snowball_32',
			'../resources/images/snowballs/snowball_32.png');
	game.load.image('snowball_48',
			'../resources/images/snowballs/snowball_48.png');
}
...
function create() {
	...
	groundSprite = game.add.tileSprite(0, game.world.height - 32, width, 32,
			'ground');
...
function useProjectile() {
	if (projectilesInUse < numOfProjectiles) {
		...
		var projectile = projectiles.create(startLocationX,
				projectileStartLocationY, 'projectile');
		projectilesInUse++;
...
function update() {
	...
	game.physics.arcade.overlap(projectiles, bounds, destroyProjectile, null,
			this);
	game.physics.arcade.overlap(projectiles, balls, projectileBallCollision,
			null, this);
